defmodule KreasidevWeb.PostControllerTest do
  use KreasidevWeb.ConnCase

  import Kreasidev.EntriesFixtures

  @create_attrs %{body: "some body", slug: "some slug", title: "some title", upvote: 42, url: "some url"}
